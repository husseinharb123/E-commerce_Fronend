...
export default function AddProductSection() {
  ...
  function ourReducer(draft, action) {
    switch (action.type) {
      case 'productname':
        ...
        break;
      case 'retailerprice':
        draft.retailerprice = action.value
        break;
        case 'price':
      ...
      case 'category':
        ...
        break;
      case 'submitform':
        if (draft.productname && draft.price && draft.in_stock && draft.discount  && draft.productdes && draft.barcode && draft.category) {
  ...
  function handlepublish(e) {
    ...
    if (!state.haserror) {
      ...
      data.append('retailerprice', state.retailerprice);
                ...
                <div className="card-body">
                  ...
                  <div className="mb-4">
                    ...
                    <input
                      ...
                      required
                      autoComplete="off"
                      onChange={(e) => dispatch({ type: 'retailerprice', value: e.target.value })}
                    />
                  </div>
